...
//                   colorInput.value = color.name.toUpperCase();
//                   suggestionsBox.classList.add("hidden");
//             });
...
//             matchedColors = COLORS_LIST.filter(c =>
//                   c.hex.toLowerCase().startsWith(cleanHex)
//             );
//       }
...
//             matchedColors = COLORS_LIST.filter(c =>
//                   `${c.rgb.r},${c.rgb.g},${c.rgb.b}`.startsWith(nums)
//             );
//       }
...
//             // 🔥 DISPLAY FORMAT SAME AS INPUT
//             if (isHex(value)) {
//                   text.textContent = `#${color.hex}`;
//             } else if (isRGB(value)) {
//                   text.textContent = rgbToString(color.rgb);
//             } else {
//                   text.textContent = color.name;
//             }
